...
function UpdateProduct2()
{
    ...
    const handleClickUpdateProduct = () => {
        ...
        requestPost.post(`api/updateProduct2`, formData, {
            headers: {
    ...
    const handleDeletePreviewImage = (type, index) => {
        if(type === 'imageFromClient'){
            ...
            // const listDeletedImgURL = infoUpdateProduct.imgurl.filter((item, indexImgurl) => {
            //     console.log(item, "okokok")
            //     if(indexImgurl === index)
            //         return item.imgURL
            // }); 
            
            infoUpdateProduct.imgurl.splice(index, 1);

            console.log(infoUpdateProduct.mahinhanh, "ok dele", infoUpdateProduct.maHinhAnhDeleted);
        } 
        ...
        //     setInfoUpdateProduct({...infoUpdateProduct, indexThumnail: infoUpdateProduct.indexThumnail - 1});
